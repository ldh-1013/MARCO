...
namespace FishNet.Managing.Scened
{
    ...
    {
        /// <summary>
        /// Handle of the scene as raw data (SceneHandle.GetRawData()). If value is 0, then handle is not used.
        /// Unity 6000.5+ removed the implicit SceneHandle/int conversions, so handles are stored
        /// as the full 64-bit raw value rather than a truncated int.
        /// </summary>
        public ulong Handle;
        /// <summary>
        /// Name of the scene.
